...
connection = pymysql.connect(host='localhost',user='root',password='Workbench@369',db='cv')
...
st.set_page_config(
   ...
   page_icon='C:\Harshitha\Projects\Resume\Logo\Logo.png',
)
def run():
    img = Image.open('C:\Harshitha\Projects\Resume\Logo\Logo.png')
    ...
    link = '[©Developed by Satya Harshitha Danda](www.linkedin.com/in/satya-harshitha-danda/)'
